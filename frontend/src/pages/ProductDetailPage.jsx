      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {isError && (
          <div className="flex flex-col items-center justify-center py-24 text-center gap-4">
            ...
            <p className="text-sm" style={{ color: "var(--text-muted)" }}>The product you're looking for doesn't exist or was removed.</p>
            <Link
              to="/shop"
        ...
        {product && (
          <>
            {/* Breadcrumb */}
            <nav
              className="flex items-center gap-2 text-xs mb-8 uppercase tracking-widest"
              style={{ color: "var(--text-muted)" }}
              aria-label="Breadcrumb"
            >
              <Link to="/" className="hover:underline transition-colors" style={{ color: "var(--text-secondary)" }}>Home</Link>
              <ChevronRight size={12} />
              <Link to="/shop" className="hover:underline transition-colors" style={{ color: "var(--text-secondary)" }}>Shop</Link>
              <ChevronRight size={12} />
              <Link
              ...
              <ChevronRight size={12} />
              <span className="normal-case font-medium" style={{ color: "var(--text-primary)" }}>{product.name}</span>
            </nav>
            ...
            <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-16">
              ...
              <div className="relative group/carousel select-none">
                ...
                <div
                  ...
                  style={{
                    backgroundColor: hasRealImage ? "var(--bg-card)" : product.color || "var(--bg-card)",
                  ...
                  >
                    {hasRealImage ? (
                      ...
                      <div className="h-full w-full flex flex-col items-center justify-center gap-4">
                        <ShoppingBag size={80} style={{ color: "var(--text-muted)" }} />
                        <p className="text-sm" style={{ color: "var(--text-muted)" }}>Image coming soon</p>
                      </div>
                    )}
                  </div>
              ...
              <div className="flex flex-col">
                ...
                <div className="h-px mb-6" style={{ backgroundColor: "var(--border-light)" }} />
                ...
                {product.sizes && product.sizes.length > 1 && (
                  <div className="mb-6">
                    <p className="text-sm font-semibold mb-3 tracking-wide" style={{ color: "var(--text-secondary)" }}>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {product.sizes.map((size) => (
                        <button
                          ...
                          className={`h-10 min-w-[2.5rem] px-3 rounded-xl text-sm font-semibold border transition-all duration-200 focus:outline-none ${
                            selectedSize === size
                ...
                {/* Quantity Selector */}
                <div className="mb-8">
                  <p className="text-sm font-semibold mb-3 tracking-wide" style={{ color: "var(--text-secondary)" }}>Quantity</p>
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <button
                        ...
                        className="h-9 w-9 flex items-center justify-center rounded-lg transition-all duration-200 focus:outline-none"
                      ...
                      <button
                        ...
                        className="h-9 w-9 flex items-center justify-center rounded-lg transition-all duration-200 focus:outline-none disabled:opacity-30 disabled:cursor-not-allowed"
                        style={{ color: "var(--text-primary)" }}
                      >
            ...
            {otherProducts.length > 0 && (
              <section className="mt-24" aria-label="Related products">
                <div className="flex items-end justify-between mb-8">
                  ...
                  <Link
                    to="/shop"
                    className="text-sm hover:underline transition-colors hidden sm:block"
                    style={{ color: "var(--text-secondary)" }}
                  >
                    View all →
                  </Link>
